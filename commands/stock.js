...
module.exports = {
	...
	description: 'Displays The Service Stock.', // Command description
	...
	execute(message) {
        ...
        fs.readdir(`${__dirname}/../stock/`, function (err, files) {
            ...
            if (err) return console.log('I Cannot Scan The' + err + 'Directory Because You Are A Monkey.');
            ...
            .setTitle(`${message.guild.name} Contains **${stock.length} Services**`)
            .setDescription('')
